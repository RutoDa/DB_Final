...
<head>
  ...
  <title><?php echo $row['real_name'];?></title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg">
    <div class="container"> <a class="navbar-brand navbar-logo" href="../index.html"> <img
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"> <a class="nav-link" href="#" data-scroll-nav="1">訂單</a> </li>
  ...
  <div class="about-us section-padding" data-scroll-index='1'>
    <center>
      ...
      <div class="container" style="padding-left: 5%;">
        <h1 style="text-align: left;">可接訂單&nbsp;&nbsp;</h1>
        <br>
        <table style="font-size: 20px;color: rgb(34, 33, 33);" class="table">
          ...
          <?php
                $sql = "SELECT * FROM `order_` INNER JOIN provider ON order_.provider_id=provider.provider_id WHERE STATUS = 1 ORDER BY `order_`.`date` DESC;";
                $result=mysqli_query($conn, $sql);
                while($row = mysqli_fetch_assoc($result)){
                  ...
                  echo "<td><a href='d_check.php?id=".$row['order_id']."'><button class='btn btn-primary'>接單</button></a></td>";
                  echo "</tr>";
                }
                ?>
